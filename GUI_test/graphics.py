...
def submit_watermarkupload(overall_validity):
    ...
    percentage_screen = load_image()
    if overall_validity > 70: #overall validity catogorised from prototype 2
        message = "Watermark Found"
    elif 20 < overall_validity <= 70:
        message = "Watermark Distorted"
    else:
        message = "No Watermark Found"
    
    #centred text label which displays the percentage confidence 
